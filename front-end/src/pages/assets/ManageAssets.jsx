...
export default function ManageAssets() {
    ...
    const [disableStyle,setDisableStyle] = useState({style:{  color: "red"}});
        ...
        axios.all([getCategory, getAsset]).then(axios.spread((...responses) => {
            ...
            assets.forEach(asset => {
                ...
                if(asset.state === 'Assigned'){
                    setDisableStyle({...disableStyle,style:{color:'#f4d7db'}})
                }
                                ...
                                setDeleteModal({
                                    ...
                                    footer: (<div style={{textAlign: 'left'}}>
                                        <Button
                                            ...
                                            onClick={() => {
                                                axios.delete(`https://https://localhost:7004/api/Assets?id=${asset.id}`).then(
                                                    (response) => {
